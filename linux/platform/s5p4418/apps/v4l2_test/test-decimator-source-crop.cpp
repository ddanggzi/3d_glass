...
// # ./test module w h crop_width crop_height [option: loop count]
int main(int argc, char *argv[])
{
    ...
    if (argc >= 3) {
        ...
        printf("usage: ./test module width height crop_width crop_height [option: loop count]\n");
        return 0;
    }
    printf("module %d, width %d, height %d, crop_width %d, crop_height %d\n", module, width, height, crop_width, crop_height);
    ...
    CHECK_COMMAND(v4l2_set_crop(decimator_id, 0, 0, crop_width, crop_height));
