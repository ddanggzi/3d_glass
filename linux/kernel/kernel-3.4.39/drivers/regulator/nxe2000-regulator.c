		...
		struct nxe2000_regulator_platform_data *nxe2000_pdata)
{
    ...
    printk("TTTTTTTTTTTT = %d\r\n", ri->id);

	if(ri->id == NXE2000_ID_DC1 || ri->id == NXE2000_ID_DC2) 
	{
		printk("TTTTTTTTTTTT11111 = %d\r\n", ri->id);
		return ret;
	}
#endif
...
static int __devinit nxe2000_regulator_probe(struct platform_device *pdev)
{
	...
	printk("BBBBBBBBBBBBBBBBBBBBBBBBBB====1\r\n");
	...
	printk("BBBBBBBBBBBBBBBBBBBBBBBBBB====2\r\n");
	if (err) {
	...
	printk("BBBBBBBBBBBBBBBBBBBBBBBBBB====3\r\n");
