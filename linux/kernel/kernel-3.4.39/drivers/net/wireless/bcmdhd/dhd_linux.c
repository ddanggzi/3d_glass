...
int dhd_do_driver_init(struct net_device *net)
{
    ...
    printk("SSSSSSSSSSSSSSSSSSSSSSSSSSSS\r\n");
...
//	if (!dhd_download_fw_on_driverload) {
		...
		fw = BCMDHD_FW_PATH;
		printf("fw= %s\r\n", BCMDHD_FW_PATH);
#endif /* BCMDHD_FW_PATH */
#ifdef BCMDHD_NVRAM_PATH
		nv = BCMDHD_NVRAM_PATH;
		printf("nv = %s\r\n", BCMDHD_NVRAM_PATH);
#endif /* BCMDHD_NVRAM_PATH */
//	}
