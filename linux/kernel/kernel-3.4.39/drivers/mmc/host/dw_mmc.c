...
void brcm4356_wlan_set_carddetect(int onoff)
{
//	printk("[BUMNUX] %s : %d\n", __func__, onoff);
//	bt_wlan_lock();
	if (onoff) {
		// modifeid by ddanggzi
	...
	mmc_force_presence_change(&dwmci_dev_ch1, onoff);
	// end
	msleep(500); /* wait for carddetect */
   //	bt_wlan_unlock();
	//return 0;
}
EXPORT_SYMBOL_GPL(brcm4356_wlan_set_carddetect);
