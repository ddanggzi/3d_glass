...
/* gpio i2c4 */
#define	I2C4_SCL	PAD_GPIO_C + 7
#define	I2C4_SDA	PAD_GPIO_C + 8
...
// modified by Rosemary
//NXE2000_PDATA_INIT(dc4,      0,	1000000, 2000000, 1, 1, 1200000, 1, -1);	/* 1.2V LDDR3 */
//NXE2000_PDATA_INIT(dc5,      0,	1000000, 2000000, 1, 1, 1200000, 1,  4);	/* 1.2V SYS */
...
NXE2000_PDATA_INIT(ldo1,     0,	1000000, 3500000, 0, 0, 2500000, 0,  0);	/* 2.5V GMAC */
NXE2000_PDATA_INIT(ldo2,     0,	1000000, 3500000, 0, 0,     -1, 0,  0);	/* NC */

// modified by Rosemary
//NXE2000_PDATA_INIT(ldo3,     0,	1000000, 3500000, 1, 1, 1800000, 1,  2);	/* 1.8V VCC SYS*/
//NXE2000_PDATA_INIT(ldo4,     0,	1000000, 3500000, 1, 1, 1800000, 1,  2);	/* 1.8V VDD SYS*/
NXE2000_PDATA_INIT(ldo3,     0,	1000000, 3500000, 1, 1, 1900000, 1,  2);	/* 1.8V VCC SYS*/
NXE2000_PDATA_INIT(ldo4,     0,	1000000, 3500000, 1, 1, 1900000, 1,  2);	/* 1.8V VDD SYS*/


// modified by Rosemary
//NXE2000_PDATA_INIT(ldo5,     0,	1000000, 3500000, 1, 1, 1800000, 1, -1);	/* 1.8V LPDDR*/
// not used in Rosemary
...
NXE2000_PDATA_INIT(ldo7,     0,	1000000, 3500000, 1, 1, 2800000, 1,  1);	/* 2.8V VID */
NXE2000_PDATA_INIT(ldo8,     0,	1000000, 3500000, 0, 0,     -1, 0,  0);	/* NC */
NXE2000_PDATA_INIT(ldo9,     0,	1000000, 3500000, 0, 0, 3300000, 0,  0);	/* 3.3V AUD */
NXE2000_PDATA_INIT(ldo10,    0,	1000000, 3500000, 0, 0, 1200000, 0,  0);	/* 1.2V CVBS */
...
static struct dw_mci_board _dwmci0_data = {
	...
	.caps			= MMC_CAP_UHS_DDR50 |
					  MMC_CAP_NONREMOVABLE |
				  	  ...
				  	  MMC_CAP_HW_RESET,
	.clk_dly        = DW_MMC_DRIVE_DELAY(0x3F) | DW_MMC_SAMPLE_DELAY(0x7F) | DW_MMC_DRIVE_PHASE(2) | DW_MMC_SAMPLE_PHASE(0), 
...
static struct dw_mci_board _dwmci1_data = {
	...
	.pm_caps        = MMC_PM_KEEP_POWER | MMC_PM_IGNORE_PM_NOTIFY,
	//.clk_dly        = DW_MMC_DRIVE_DELAY(0) | DW_MMC_SAMPLE_DELAY(0) | DW_MMC_DRIVE_PHASE(0) | DW_MMC_SAMPLE_PHASE(0),
	.clk_dly        = DW_MMC_DRIVE_DELAY(0x0F) | DW_MMC_SAMPLE_DELAY(0x7F) | DW_MMC_DRIVE_PHASE(10) | DW_MMC_SAMPLE_PHASE(0), 
#if defined (CONFIG_MMC_DW_IDMAC) && defined (CONFIG_MMC_NXP_CH1_USE_DMA)
    .mode       	= DMA_MODE,
#else
    .mode       	= PIO_MODE,
