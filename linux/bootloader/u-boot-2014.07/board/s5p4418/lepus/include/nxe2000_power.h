...
#define	NXE2000_DEF_LDO1_VOL				2500000	/* VAL(uV) = 0: 0.90 ~ 3.5V, Step = 25mV, default(OTP) = 3.30V */
...
#define	NXE2000_DEF_LDO1_SLP_VOL			2500000	/* VAL(uV) = 0: 0.90 ~ 3.5V, Step = 25mV, default(OTP) = 3.30V */
