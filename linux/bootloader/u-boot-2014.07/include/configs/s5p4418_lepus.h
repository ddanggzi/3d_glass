...
#define CONFIG_ENV_IS_IN_MMC
    ...
    // < success #1 >
	//#define CONFIG_MMC0_CLK_DELAY       DW_MMC_DRIVE_DELAY(0x1c) | DW_MMC_SAMPLE_DELAY(0x3c) | DW_MMC_DRIVE_PHASE(2)| DW_MMC_SAMPLE_PHASE(0)
	//#define CONFIG_MMC0_CLK_DELAY       DW_MMC_DRIVE_DELAY(0x1c) | DW_MMC_SAMPLE_DELAY(0x7c) | DW_MMC_DRIVE_PHASE(2)| DW_MMC_SAMPLE_PHASE(0)
    // < success #2 >
    ...
    #define CONFIG_MMC0_TRANS_MODE      0
