...
@ -I /home/ddanggzi/lepus/linux/bootloader/u-boot-2014.07/arch/arm/include
@ -I /home/ddanggzi/lepus/linux/bootloader/u-boot-2014.07/arch/arm/cpu/slsiap/s5p4418/prototype/module
@ -I /home/ddanggzi/lepus/linux/bootloader/u-boot-2014.07/arch/arm/cpu/slsiap/s5p4418/prototype/base
@ -I /home/ddanggzi/lepus/linux/bootloader/u-boot-2014.07/arch/arm/include/asm/arch-s5p4418
@ -I /home/ddanggzi/lepus/linux/bootloader/u-boot-2014.07/arch/arm/cpu/slsiap/common
@ -I /home/ddanggzi/lepus/linux/bootloader/u-boot-2014.07/arch/arm/cpu/slsiap/devices
@ -I /home/ddanggzi/lepus/linux/bootloader/u-boot-2014.07/board/s5p4418/common
@ -I /home/ddanggzi/lepus/linux/bootloader/u-boot-2014.07/board/s5p4418/lepus/include
@ -iprefix /home/ddanggzi/lepus/prebuilts/gcc/linux-x86/arm/arm-eabi-4.8/bin/../lib/gcc/arm-eabi/4.8/
@ -D__USES_INITFINI__ -D __KERNEL__ -D CONFIG_SYS_TEXT_BASE=0x42C00000
@ -D CONFIG_ARM -D __ARM__ -D __LINUX__ -D NX_RELEASE
@ -D __SUPPORT_MIO_UBOOT__ -D __SUPPORT_MIO_UBOOT_CHIP_S5P4418__
...
@ -MD lib/.asm-offsets.s.d lib/asm-offsets.c -mcpu=cortex-a9
@ -mcpu=cortex-a9 -mfloat-abi=soft -mfpu=vfp -mabi=aapcs
...
.LFE144:
	...
	.text
.Letext0:
	.file 2 "/home/ddanggzi/lepus/linux/bootloader/u-boot-2014.07/arch/arm/include/asm/types.h"
...
.LASF57:
	.ascii	"/home/ddanggzi/lepus/u-boot\000"
.LASF58:
...
.LASF48:
	.ascii	"priv\000"
.LASF55:
	.ascii	"GNU C 4.8 -mcpu=cortex-a9 -mcpu=cortex-a9 -mfloat-a"
	.ascii	"bi=soft -mfpu=vfp -mabi=aapcs -g -Os -fno-builtin -"
	.ascii	"ffreestanding -fno-stack-protector -fstack-usage -f"
	.ascii	"function-sections -fdata-sections -fno-common -ffix"
	.ascii	"ed-r9 -fno-short-enums -fstrict-aliasing\000"
.LASF31:
